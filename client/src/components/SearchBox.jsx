    ...
    <div>
      <form onSubmit={handleSubmit} className="flex">
        <div className="relative">
          <FaSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-700 h-4 w-4" />
          <Input
            value={input}
            onChange={(e) => setInput(e.target.value)}
            placeholder="Search Here...."
            className="h-9 bg-gray-100 pl-9 w-[500px]" // Important: left padding to make space for icon
          />
